  ...
  return (
    <div>
      ...
      <div className="h-screen lg:h-[70vh] lg:min-h-[40rem] bg-primary">
        <div className="h-[40%] lg:h-full bg-[url(/assets/fassadendämmung.webp)] bg-center bg-cover border-b-white lg:border-b-primary border-b-2 lg:border-b-4 relative">
          <div className="absolute inset-0 flex flex-col justify-center" style={{ background: "rgba(0,71,67, .29)" }}>

            {/* desktop */}
            <div className="hidden lg:block px-16 max-w-4xl">
              <div className="text-4xl font-bold text-white">
                Ihr Generalunternehmer <br /> und Fachbetrieb für <br /> energieeffiziente Fassadendämmung
              </div>
              <br />
              ...
              <br />
              <div className="">
                <a href="#kontaktformular" type="submit" className="inline-block w-max bg-white hover:bg-slate-100 p-2 text-sm text-black font-medium leading-normal">
        ...
        <div className="text-white py-4 px-4 h-[60%] flex justify-start items-center lg:hidden">
          <div className="">
            ...
            <br />
            <div className="">
              <a href="#kontaktformular" type="submit" className="inline-block w-max bg-slate-300 p-2 text-sm text-black font-medium leading-normal hover:bg-slate-400">
      ...
      <div className="px-4 py-8 lg:hidden">
        <h2>
          ...
          <div className="text-gray-600">
            Lassen Sie uns gemeinsam erkunden, welche Vorteile wir Ihnen durch eine individuelle Fassadendämmung bieten können.
          </div>
        </h2>
      ...
      {/* Block 1 - Desktop */}
      <div className="p-16 hidden lg:block">
        <div className="flex gap-x-16">

          <div className="rounded w-[55%] bg-[url(/assets/fassade_v_n.webp)] bg-cover bg-center" />
      ...
      {/* Block 2 */}
      <div className="px-4 py-8 lg:p-16 bg-primary text-white" style={{ background: "" }}>
        <div className="flex flex-col lg:flex-row gap-x-16">
          <div className="lg:w-[60%]">
            <div className="text-xl lg:text-4xl mb-2 font-bold">
              Sanierungskonzept
            </div>
            <div className="flex flex-col space-y-4 lg:text-lg h-full">
              <div>
                Gemeinsam finden wir die beste Dämmoption für Ihre Immobilie und klären, ob ein hochwertiger Putz oder robuste Klinker die ideale Wahl für Ihre Fassade.
              </div>
              <div className="">
              ...
              {/* Block 3 - Desktop */}
              <div className="px-20 h-full hidden lg:grid place-items-center ">
          ...
          <div className="lg:w-[40%] mt-4 lg:mt-0">
            <div className="text-xl lg:text-4xl mb-3 font-bold">
              Sanierungsprozess
            </div>
      ...
      {/* Kontaktformular */}
      <div className="bg-slate-50 p-4 lg:p-16 border-y border-y-primary" id="kontaktformular">
